    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent pl-0" style="padding-top:0.7rem;padding-bottom:0.7rem">
                ...
                <li class="breadcrumb-item"><a href="#">Surat Disposisi Masuk</a></li>
            </ol>
        </nav>
        <!-- <div class="list-group list-group-flush mt-3"> -->
        <div class="list-group list-group-flush" v-for="(inbox, index) in getSuratMasuk" :key="index" >
            <div v-if="inbox.statusApp == 'Jawaban Disposisi'">
            <a href="#!" class="list-group-item list-group-item-action" :class="inbox.status === 'buka' ? 'bg-green-100' : ''">
                <!-- <div v-if="inbox.statusApp == 'Jawaban Disposisi'"> -->
